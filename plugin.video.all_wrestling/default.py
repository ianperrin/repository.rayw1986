...
def getWWE():
        ...
        addDirMain('WWE Raw',main_url+'wwe/wwe-raw/',1,art_url+'2015/06/Raw-640x360.png')
        ...
        addDirMain('WWE Network',main_url+'wwe/wwe-network/',1,art+'wwe.png')
...
def getSource(url):
    ...
    for entry in wwetalks:
        ...
        source = plugintools.find_single_match(entry,'wid(.+?)=').replace('=1&amp;id','DAILYMOTION').replace('=3&amp;id','NOWVIDEO').replace('=5&amp;id','NOVAMOV').replace('=6&amp;id','CLOUDY').replace('=7&amp;id','VODLOCKER').replace('=8&amp;id','YOUWATCH').replace('=9&amp;id','VIDTO').replace('=11&amp;id','BESTREAMS')
        part = plugintools.find_single_match(entry,'000000">(.+?)</span>').replace(' F','F').replace(' P','P')
        get_url = plugintools.find_single_match(entry,'wid(.+?)=').replace('=1&amp;id','http://www.dailymotion.com/video/').replace('=3&amp;id','http://www.nowvideo.sx/video/').replace('=5&amp;id','http://www.auroravid.to/video/').replace('=6&amp;id','http://www.cloudy.ec/v/').replace('=7&amp;id','http://vodlocker.com/').replace('=8&amp;id','http://youwatch.org/').replace('=9&amp;id','http://www.vidto.me/').replace('=11&amp;id','http://www.bestreams.net/')
